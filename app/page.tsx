...
export default function Home() {
  ...
  const closeCase = () => { setClosingCase(true); window.setTimeout(()=>{setSelected(null);setClosingCase(false)},520); };
  return <main ref={root}>
    ...
    <section className="work depth-section" id="work">
